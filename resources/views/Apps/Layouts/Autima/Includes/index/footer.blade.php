                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widgets_container contact_us">
                        <div class="footer_logo">
                            <a href="#"><img src="<?php echo $_config_base_url . '/Lib/autima/assets/img/logo/logo.png';?>" alt=""></a>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="footer_payment text-right">
                        <a href="#"><img src="<?php echo $_config_base_url . '/Lib/autima/assets/img/icon/payment.png';?>" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
