        ...
        <div class="row">
                                ...
                                <ul class="categories_mega_menu">
                                    ...
                                    <li class="menu_item_children last_child"><a href="#">Wheel Simulators</a>
                                        ...
                                        <div class="categorie_banner">
                                            <a href="#"><img src="<?php echo $_config_base_url . '/Lib/autima/assets/img/bg/banner2.jpg';?>" alt=""></a>
                                        </div>
                                    </li>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="slider_area owl-carousel">
                    <div class="single_slider d-flex align-items-center" data-bgimg="<?php echo $_config_base_url . '/Lib/autima/assets/img/slider/slider1.jpg';?>" alt=""
                    ...
                    <div class="single_slider d-flex align-items-center" data-bgimg="<?php echo $_config_base_url . '/Lib/autima/assets/img/slider/slider2.jpg';?>" alt=""
                        <div class="slider_content">
                    ...
                    <div class="single_slider d-flex align-items-center" data-bgimg="<?php echo $_config_base_url . '/Lib/autima/assets/img/slider/slider3.jpg';?>" alt=""
                        <div class="slider_content">
                            <h2>Engine Oils</h2>
